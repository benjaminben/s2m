  ...
  return (
    <div id="Controls">
      <svg id="d-pad" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98.85 98.7">
        <g id="up" data-keycode="UP"
                   className={`btn ${props['onUP'] ? 'on' : ''}`}
        ...
        <g id="right" data-keycode="RIGHT"
                      className={`btn ${props['onRIGHT'] ? 'on' : ''}`}
                      onTouchStart={props.handleBtnOn}
                      onTouchEnd={props.handleBtnOff} >
        ...
        <g id="down" data-keycode="DOWN"
                     className={`btn ${props['onDOWN'] ? 'on' : ''}`}
                     onTouchStart={props.handleBtnOn}
                     onTouchEnd={props.handleBtnOff} >
        ...
        <g id="left" data-keycode="LEFT"
                     className={`btn ${props['onLEFT'] ? 'on' : ''}`}
                     onTouchStart={props.handleBtnOn}
                     onTouchEnd={props.handleBtnOff} >
      ...
      <svg id="ab" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 53.65 53.65">
        <g id="A" data-keycode="A"
                  className={`btn ${props['onA'] ? 'on' : ''}`}
                  onTouchStart={props.handleBtnOn}
                  onTouchEnd={props.handleBtnOff} >
        ...
        <g id="B" data-keycode="B"
                  className={`btn ${props['onB'] ? 'on' : ''}`}
                  onTouchStart={props.handleBtnOn}
                  onTouchEnd={props.handleBtnOff} >
